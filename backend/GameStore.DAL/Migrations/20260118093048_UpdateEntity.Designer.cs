...
namespace GameStore.DAL.Migrations
{
    ...
    [Migration("20260118093048_UpdateEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Models.DbOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameStore.Models.DbOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameStore.Models.DbPublisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameStore.Models.DbComment", b =>
                {
                    ...
                    b.HasOne("GameStore.Models.DbComment", "Parent")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("GameStore.Models.DbGame", b =>
                {
                    b.HasOne("GameStore.Models.DbPublisher", "Publisher")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("GameStore.Models.DbOrderDetail", b =>
                {
                    b.HasOne("GameStore.Models.DbOrder", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameStore.Models.DbGame", "Product")
                        .WithMany()
